class UI {
  ...
  showProfile(user) {
    ...
    <div class="card card-body mb-3">
     <div class="row>
       ...
       <div class="col-md-9">
        ...
        <span class=" badge badge-secondary mb-2">Public Repos: ${user.public_gists}</span>
    ...
    <h3 class="page-heading mb-3">Latest Repos</h2>
    <div id="repos"></div>
    `;
  }
    ...
    repos.forEach(function(repo) {
      ...
      <div class="card card-body mb-2">
        <div class="row>"
          ...
          <div class="col-md-6">
          <span class=" badge badge-primary mb-2">Stars: ${repo.stargazer_count}</span>
